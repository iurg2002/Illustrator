...
// var names = 	[["R", "A"], ["Emanuel", "Elisaveta"], ["Nico", "Alex"], ]
var names = 			[
  'Alina',
'Betb',
'Carolinc',
...
for (var i = 0; i < names.length; i++) {
  ...
  create2NameSTD(names[i], textLayer, circleLayer, x, y)
    y -= 80;
}
...
function createSetInel2Nume(name, textLayer,circleLayer,  x, y)
{
  ...
  // setting the font and character size
  var textRange1 = textFrame.textRange;
  textRange1.characterAttributes.textFont = app.textFonts.getByName("Stash-Black");
  textRange1.characterAttributes.size = 18;

  var textRange2 = textFrame2.textRange;
  textRange2.characterAttributes.textFont = app.textFonts.getByName("Stash-Black");
...
function createNameBigSpender(name, textLayer,circleLayer, x, y)
{
  ...
  // setting the font and character size
  var textRange = textFrame.textRange;
  textRange.characterAttributes.textFont = app.textFonts.getByName("BigSpenderColier");
...
function create2NameSTD(name, textLayer,circleLayer,  x, y)
{
  ...
  // setting the font and character size
  var textRange = textFrame.textRange;
  textRange.characterAttributes.textFont = app.textFonts.getByName("KuenstlerScriptLTStd-ColierRegular");
